...
#
# /flash/dtb.xml can be forced updated by a tar update by changing any 'version'
# of a option node. So Team CoreELEC is still able to maintain user /flash/dtb.xml.
#
